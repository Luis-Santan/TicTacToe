...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
   ...
   // private FirebaseAnalytics mFirebaseAnalytics;
    Button boton1, boton2,boton3,boton4,boton5,boton6,boton7,boton8,boton9,reset;
    int chance = 0;
    @Override
    ...
    public  void  resultado(){
        ...
        if(boton1.getText().toString().equals("X")
                && boton2.getText().toString().equals("X")
                && boton3.getText().toString().equals("X")){
            Toast.makeText(this,"Player X WIN",Toast.LENGTH_SHORT).show();
            reset.callOnClick();
        }
        else if(boton4.getText().toString().equals("X")
                && boton5.getText().toString().equals("X")
                && boton6.getText().toString().equals("X")){
            Toast.makeText(this,"Player X WIN",Toast.LENGTH_SHORT).show();
            reset.callOnClick();
        }
        else if(boton7.getText().toString().equals("X")
                && boton8.getText().toString().equals("X")
                && boton9.getText().toString().equals("X")){
            Toast.makeText(this,"Player X WIN",Toast.LENGTH_SHORT).show();
            reset.callOnClick();
        }

        else if(boton1.getText().toString().equals("O")
                && boton2.getText().toString().equals("O")
                && boton3.getText().toString().equals("O")){
